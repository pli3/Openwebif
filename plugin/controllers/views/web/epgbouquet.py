...
__CHEETAH_genTime__ = 1364979192.031906
__CHEETAH_genTimestamp__ = 'Wed Apr  3 17:53:12 2013'
__CHEETAH_src__ = '/home/fermi/Work/Model/tmsingle/openpli3.0/build-tmsingle/tmp/work/mips32el-oe-linux/enigma2-plugin-extensions-openwebif-0.1+git1+279a2577c3bc6defebd4bf9e61a046dcf7f37c01-r0.72/git/plugin/controllers/views/web/epgbouquet.tmpl'
...
class epgbouquet(Template):
    ...
    def __init__(self, *args, **KWs):
        ...
        super(epgbouquet, self).__init__(*args, **KWs)
...
''')
        write(u'''</e2eventlist>
''')
        _filter = self._CHEETAH__currentFilter = _orig_filter_49610349
    ...
    _mainCheetahMethod_for_epgbouquet= 'respond'

## END CLASS DEFINITION

if not hasattr(epgbouquet, '_initCheetahAttributes'):
    templateAPIClass = getattr(epgbouquet, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(epgbouquet)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=epgbouquet()).run()

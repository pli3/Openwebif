...
__CHEETAH_genTime__ = 1364979193.863
__CHEETAH_genTimestamp__ = 'Wed Apr  3 17:53:13 2013'
__CHEETAH_src__ = '/home/fermi/Work/Model/tmsingle/openpli3.0/build-tmsingle/tmp/work/mips32el-oe-linux/enigma2-plugin-extensions-openwebif-0.1+git1+279a2577c3bc6defebd4bf9e61a046dcf7f37c01-r0.72/git/plugin/controllers/views/mobile/channels.tmpl'
...
\t\t\t\t<li data-role="list-divider" role="heading" data-theme="b">Channels</li>\r
''')
        for channel in VFFSL(SL,"channels",True): # generated from line 22, col 5
            write(u'''\t\t\t\t<li>\r
\t\t\t\t<a href="/mobile/channelinfo?sref=''')
            _v = VFFSL(SL,"channel.ref",True) # u'$channel.ref' on line 24, col 39
            if _v is not None: write(_filter(_v, rawExpr=u'$channel.ref')) # from line 24, col 39.
            write(u'''" style="padding: 3px;">\r
\t\t\t\t<span class="ui-li-heading" style="margin-top: 0px; margin-bottom: 3px;">''')
            _v = VFFSL(SL,"channel.name",True) # u'$channel.name' on line 25, col 78
            if _v is not None: write(_filter(_v, rawExpr=u'$channel.name')) # from line 25, col 78.
            write(u'''</span>\r
''')
            if VFN(VFFSL(SL,"channel",True),"has_key",False)('now_title'): # generated from line 26, col 5
                write(u'''\t\t\t\t<span class="ui-li-desc" style="margin-bottom: 0px;">''')
                _v = VFFSL(SL,"channel.now_title",True) # u'$channel.now_title' on line 27, col 58
                if _v is not None: write(_filter(_v, rawExpr=u'$channel.now_title')) # from line 27, col 58.
                write(u'''</span>\r
''')
            write(u'''\t\t\t\t</a>\r
\t\t\t\t</li>\r

...
__CHEETAH_genTime__ = 1364979193.853534
__CHEETAH_genTimestamp__ = 'Wed Apr  3 17:53:13 2013'
__CHEETAH_src__ = '/home/fermi/Work/Model/tmsingle/openpli3.0/build-tmsingle/tmp/work/mips32el-oe-linux/enigma2-plugin-extensions-openwebif-0.1+git1+279a2577c3bc6defebd4bf9e61a046dcf7f37c01-r0.72/git/plugin/controllers/views/mobile/screenshot.tmpl'
...
\t\t\r
\t\t<div>\r
\t\t\t<fieldset data-type="horizontal" data-role="controlgroup" style="width: 260px; margin: auto; margin-top: 15px;">\r
...
\t\t\t   <div onClick="jQuery(\'#screenshot\').attr(\'src\',\'/grab?r=275&mode=osd&timestamp=\' + new Date().getTime()); return false;"><input type="radio" id="radio-view-c" name="radio-view"><label for="radio-view-c" data-theme="c">OSD</label></div>\r
\t\t\t</fieldset>\r
\t\t\t\r
\t\t\t<div id="mainContent">\r
\t\t\t\t<img id="screenshot" src="/grab?r=275&mode=all" width="275" height="154" alt="Screenshot">\r
\t\t\t</div>\r
\t\t\t\r
\t\t\t<a href="#" onClick="location.reload(true)" data-role="button">Refresh</a>\r
\t\t\t\r
\t\t\t<div id="footer">\r

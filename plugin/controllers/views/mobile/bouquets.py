...
__CHEETAH_genTime__ = 1364979193.871917
__CHEETAH_genTimestamp__ = 'Wed Apr  3 17:53:13 2013'
__CHEETAH_src__ = '/home/fermi/Work/Model/tmsingle/openpli3.0/build-tmsingle/tmp/work/mips32el-oe-linux/enigma2-plugin-extensions-openwebif-0.1+git1+279a2577c3bc6defebd4bf9e61a046dcf7f37c01-r0.72/git/plugin/controllers/views/mobile/bouquets.tmpl'
...
\t\t\t\t<li data-role="list-divider" role="heading" data-theme="b">Bouquets</li>\r
''')
        for bouquet in VFFSL(SL,"bouquets",True): # generated from line 23, col 5
            write(u'''\t\t\t\t<li><a href="/mobile/channels?id=''')
            _v = VFFSL(SL,"quote",False)(VFFSL(SL,"bouquet",True)[0]) # u'$quote($bouquet[0])' on line 24, col 38
            if _v is not None: write(_filter(_v, rawExpr=u'$quote($bouquet[0])')) # from line 24, col 38.
            write(u'''">''')
            _v = VFFSL(SL,"bouquet",True)[1] # u'$bouquet[1]' on line 24, col 59
            if _v is not None: write(_filter(_v, rawExpr=u'$bouquet[1]')) # from line 24, col 59.
            write(u'''</a></li>\r
''')
        write(u'''\t\t\t</ul>\r
\t\t</div>\r
